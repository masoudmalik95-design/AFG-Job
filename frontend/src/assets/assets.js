...
import download_image from "../assets/download.webp";
...
import Shams from "./testimonials/Shams.png";
import Heshmat from "./testimonials/Heshmat.png";
import Javid from "./testimonials/Javid.png";
import MQ from "./testimonials/M.Q.png";
import Sadi from "./testimonials/Sadi.png";
...
export const testimonials = [
  {
    title: "یک تجربه فوق العاده",
    description:
      "قبلاً برای پیدا کردن کار با مشکلات زیادی روبه‌رو می‌شدم، اما این سایت باعث شد فرصت‌های شغلی مختلف را در یک مکان پیدا کنم و برای موقعیت مناسب درخواست بدهم.",
    image: MQ,
    name: "مودود",
    position: "توسعه دهنده وب",
  },
  {
    title: "شدیدا توصیه میکنم",
    description:
      "از ساختن پروفایل تا پیدا کردن و ارسال درخواست برای شغل، همه چیز بسیار ساده و منظم بود این سایت را به کسانی که دنبال کار هستند پیشنهاد می‌کنم",
    image: Javid,
    name: "جاوید",
    position: "تحلیل گر داده",
  },
  {
    title: "روان و کار آمد",
    description:
      "به کمک این سایت توانستم در مدت کوتاهی فرصت شغلی مناسبی پیدا کنم طراحی سایت ساده و استفاده از امکانات آن بسیار آسان است.",
    image: Heshmat,
    name: "حشمت",
    position: "UI/UX طراح",
  },
  {
    title: "یک تحول بزرگ برای کار جویان",
    description:
      "استفاده از این سایت جستجوی کار را برایم بسیار ساده‌تر کرد فرصت‌های شغلی متناسب با مهارت‌ هایم را به‌راحتی پیدا کردم و تجربه کار با سایت هم بسیار خوب بود.",
    image: Shams,
    name: "شمس",
    position: "مدیر پروژه",
  ...
  {
    title: "سایتی کاربری و قابل اعتماد",
    description:
      "توانستم فرصت های شعلی مناست را سریع  پیدا کنم همچنان طراحی سایت زیبا و استفاده از آن بسیار آسان بود.",
    image: Sadi,
    name: "سعدی",
    position: "امنیت سایبری",

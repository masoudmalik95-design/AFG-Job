...
const RecruiterLogin = () => {
  ...
  const recruiterLogin = async (e) => {
    ...
    try {
      ...
      toast.error(
        error?.response?.data?.message || "ورود انجام نشد"
      );
    } finally {
      setLoading(false);
    }
      ...
      <div className="min-h-screen flex flex-col bg-white dark:bg-[#0e0d0d15] transition-colors duration-300">
        <main className="flex-grow flex items-center justify-center py-10">
          ...
          <div
            className="
              w-full max-w-md
              border border-gray-200 dark:border-[#3f4245]
              rounded-lg
              p-6
          ...
          >
            ...
            <div className="text-center mb-6">
              <h1 className="text-2xl font-semibold text-gray-700 dark:text-gray-100 mb-1">
            ...
            >
              ...
              <div
                className="
                  border border-gray-300 dark:border-[#4a4d50]
                  rounded
                  flex items-center
                  p-2.5
                ...
                "
              >
                <Mail className="h-5 w-5 text-gray-400 dark:text-gray-300 mr-2" />
